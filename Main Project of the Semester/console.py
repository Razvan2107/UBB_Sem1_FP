...
from sort import insertionSort,combSort
from exceptions import ValidationException,DuplicateIDException,BookNotFoundException
...
class Console:
    ...
    def __hire(self):
        ...
        if len(customer_list)==0:
            ...
            for customer in customer_list:
                ...
                if int(customer.getId())==id_customer:
                    ok=1
                    client=customer
        if ok==0:
    ...
    def __raport1(self):
        ...
        if len(books_list)>=10:
            for i in range (0,10) and books_list[i].getNumar()!=0:
                self.__srv_books.store_raport(books_list[i])
    ...
    def sort1(self):
        """
        Sorteaza lista de inchirieri utilizand sortarea prin insertie
        """
    ...
    def ui(self):
        while True:
            ...
            print('4. find_book')
            print('5. random_book')
            print('6. show_all_books')
            print('7. add_customer')
            print('8. delete_customer')
            print('9. find_customer')
            print('10. random_customer')
            print('11. update_customer')
            print('12. show_all_customers')
            print('13. hire_book_by_customer')
            print('14. show_all_hires')
            print('15. return_book')
            print('16. show_all_returns')
            print('17. the_most10_rented')
            print('18. exit')
            #print('random_book, random_customer')
