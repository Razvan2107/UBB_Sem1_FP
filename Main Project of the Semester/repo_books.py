...
class InMemoryRepositoryBooks:
    ...
    def update_book(self,id,modified_book):
        ...
        #if id not in self.__books:
        #    raise BookNotFoundException()
        #old_book=self.__books[id]
        #self.__books[id]=modified_book
...
class BookFileRepo:
    def __init__(self,filename_books,filename_raport):
        self.__filename_books=filename_books
        self.__filename_raport=filename_raport

    def __load_from_file_books(self):
        """
        ...
        """
        try:
            f=open(self.__filename_books,'r')
    ...
    def __save_to_file_books(self,books):
        """
        ...
        :rtype:-;
        """
        with open(self.__filename_books,'w') as f:
            for book in books:
    ...
    def find_book(self,id):
        ...
        :rtype: Carte
        """
        all_books=self.__load_from_file_books()
        for book in all_books:
            if book.getId()==id:
                return book
        return None
    ...
    def store_books(self,book):
        ...
        self.__save_to_file_books(all_books)
    ...
    def get_all_books(self):
        ...
        :rtype: list of objects de tip Carte
        """
        return self.__load_from_file_books()
    ...
    def size_book(self):
        ...
        :rtype: int
        """
        return len(self.__load_from_file_books())
    ...
    def delete_all_books(self):
        ...
        :rtype:-;
        """
        self.__save_to_file_books([])

    
    def __load_from_file_raport(self):
        """
        Incarca datele din fisier
        :return: lista de carti din fisier
        :rtype: list of Carte objects
        ...
        """
        try:
            f=open(self.__filename_raport,'r')
        except IOError:
            return
        ...
        lines=f.readlines()
        for line in lines:
            carte_id,carte_titlu,carte_descriere,carte_autor,carte_status,carte_numar=[token.strip() for token in line.split(';')]
            carte_status=int(carte_status)
            carte_numar=int(carte_numar)

            s=Carte(carte_id,carte_titlu,carte_descriere,carte_autor,carte_status,carte_numar)
            raport.append(s)

        f.close()
        return raport

    def __save_to_file(self,raport):
        """
        ...
        :rtype:-;
        """
        with open(self.__filename_raport,'w') as f:
            for book in raport:
                book_string=str(book.getId())+';'+str(book.getTitlu())+';'+str(book.getDescriere())+';'+str(book.getAutor())+';'+str(book.getStatus())+';'+str(book.getNumar())+'\n'
                f.write(book_string)

    def store_raport(self,book):
        """
        Adauga o carte in raport
        :param book: cartea care se adauga
        :type book: Carte
        :return: -; raportul se modifica prin adaugarea cartii date
        :rtype:
        :raises: DuplicateIDException daca cartea exista deja
        """
        raport= self.__load_from_file_books()
        raport.append(book)
        self.__save_to_file(raport)

    def get_all_raport(self):
        """
        Returneaza o lista cu toate cartile existente din raport
        :rtype: list of objects de tip Carte
        """
        return self.__load_from_file_raport()

    def delete_all_raport(self):
        self.__save_to_file([])
...
class BookRepoFileInheritance(InMemoryRepositoryBooks):
    def __init__(self,filename):
        InMemoryRepositoryBooks.__init__(self)
    ...
    def __load_from_file(self):
        ...
        lines=f.readlines()
        for line in lines:
            book_id, book_titlu, book_descriere, book_autor, book_status, book_numar = [token.strip() for token in line.split(';')]
            book_status=int(book_status)
            book_numar=int(book_numar)

            s=Carte(book_id,book_titlu,book_descriere,book_autor,book_status, book_numar)
            InMemoryRepositoryBooks.store_books(self,s)
    ...
    def __save_to_file(self):
        ...
        :rtype:-;
        """
        all_books=InMemoryRepositoryBooks.get_all_books(self)
    ...
    def find(self,id):
        ...
        :rtype: Carte
        """
        return InMemoryRepositoryBooks.find_book(self,id)
    ...
    def store(self,book):
        ...
        :rtype:
        """
        InMemoryRepositoryBooks.store_books(self,book)
        self.__save_to_file()
    ...
    def get_all(self):
        ...
        :rtype: list of objects de tip Carte
        """
        return InMemoryRepositoryBooks.get_all_books(self)
    ...
    def size(self):
        ...
        :rtype: int
        """
        return InMemoryRepositoryBooks.size_book(self)
    ...
    def delete(self,id):
        ...
        :raises: BookNotFoundException daca id-ul nu exista
        """
        deleted_show=InMemoryRepositoryBooks.delete_by_id_book(self,id)
        self.__save_to_file()
        return deleted_show
    ...
    def update(self,id,modified_book):
        ...
        :raises: BookNotFoundException daca nu exista carte cu id dat
        """
        updated_book=InMemoryRepositoryBooks.update_book(self,id,modified_book)
        self.__save_to_file()
        return updated_book

    def delete_all(self):
        InMemoryRepositoryBooks.delete_all(self)
        self.__save_to_file()
