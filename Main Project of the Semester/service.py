...
from repo_books import InMemoryRepositoryBooks,BookFileRepo
from repo_customers import InMemoryRepositoryCustomers,CustomerFileRepo
...
class CarteService:
    ...
    def store_raport(self,carte):
        self.__validator.validate(carte)
        self.__repo.store_raport(carte)
        return carte
