...
from repo.books.repo_books import InMemoryRepositoryBooks,BookFileRepo,test_all_books_repo
from repo.customers.repo_customers import InMemoryRepositoryCustomers,CustomerFileRepo,test_all_customers_repo
from repo.hires_returns.repo_hires_returns import InMemoryRepositoryHires_Returns,Hires_ReturnsFileRepo
from service.service import CarteService,ClientService,Inchirieri_ReturnariService,test_all_books_service,test_all_customers_service

repo1=BookFileRepo('books.txt')
val1=CarteValidator()
